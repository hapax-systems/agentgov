...
`agentgov` is the bounded adoption surface for the Hapax Systems portfolio. It is usable and auditable, but this repository is still operated through a single-operator release process rather than community maintenance.
...
Use the published documentation and examples to evaluate the adoption surface. GitHub Issues remain redirect-only, not a staffed support queue.
